...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:44 GMT -->
<head>
            ...
            <div class="col-lg-6">
                <div class="left-content-area"><!-- left content area -->
                    <div class="img-wrapper">
                        <img src="assets/img/404.jpg" alt="404 error page">
                    </div>
                </div><!-- //. left content area -->
            </div>
            <div class="col-lg-6">
                <div class="right-content-area"><!-- right content area -->
                    ...
                    <span class="details">Sorry!Email Is allReady Exists</span>
                    <div class="btn-wrapper">
                        <a href="index.php" class="boxed-btn">go back home</a>
                    </div>
                </div><!-- //. right content area -->
            </div>
        </div>
