...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/blog.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:47 GMT -->
<head>
...
<section class="blog-page-content-area">
    ...
    foreach($result_blog as $show_blog){
    ...
    ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-our-story-item"><!-- single our story item -->
                    <div class="thumb">
                        <img src="admin/img_blogs/<?php echo $img_arr[0];?>" alt="our story" width="400px;" height="250px;">
                    </div>
                    <div class="conent">
                        <span class="time">February<?php echo $show_blog['title_date'] ?></span>
                        <a href="blog-details.php?id=<?php echo $show_blog['id']?>"><h4 class="title"><?php echo $show_blog['title'] ;?></h4></a>
                        <p><?php echo $show_blog['post'] ;?></p>
                    </div>
...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/blog.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:57 GMT -->
</html>