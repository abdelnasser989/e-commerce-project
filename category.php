...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/category.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:00 GMT -->
<head>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#">
                    <div class="single-cateogy-block-item"><!-- single category block item -->
                        ...
                        <div class="conent">
                            <h4 class="title">bag & leathers</h4>
                        </div>
                    </div><!-- //. single category block item -->
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
               <a href="#">
                <div class="single-cateogy-block-item"><!-- single category block item -->
                    <div class="icon">
                        <i class="flaticon-shoe"></i>
                    </div>
                    <div class="conent">
                        <h4 class="title">leather shoes</h4>
                    </div>
                </div><!-- //. single category block item -->
               </a>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
               <a href="#">
                <div class="single-cateogy-block-item"><!-- single category block item -->
                    <div class="icon watermelon">
                        <i class="flaticon-watermelon"></i>
                    </div>
                    <div class="conent">
                        <h4 class="title">organic</h4>
                    </div>
                </div><!-- //. single category block item -->
               </a>
            </div>
...
<!--                          
                        //  if(!isset($_GET['sellar'])){
                        //      $sell = $_GET['sellar'];
                        //  require_once 'admin/functions/connect.php';
                        //  $select_products = "SELECT * FROM products WHERE sellar= '$sell'";
                        //  $result_products = $connect -> query($select_products);
                        //  foreach($result_products as $show_products){
     
                        //     $imgs = $show_products['img'];
                ...
                <div class="category-sidebar"><!-- category sidebar -->
                    <div class="category-filter-widget"><!-- category-filter-widget -->
                        ...
                        <ul class="cat-list">
                            ...
                            foreach($result_category as $show_category){
                            ...
                            ?>
                            <li><a href="?id=<?php echo$show_category['id']; ?>"><?php echo $show_category['name']; ?><span class="right">+</span></a></li>
            ...
            <div class="col-lg-9">
                <div class="right-content-area"><!-- right content area -->
                          ...
                          foreach($result_products as $show_products){
                            ...
                            <div class="col-lg-4 col-md-6">
                                     <div class="single-new-collection-item"><!-- single new collections -->
                                         <div class="thumb">
                                             <img src="admin/img/<?php echo $img_arr[0]?>" alt="new collcetion image" style='height:199px; width:300px; border-raduis-top:40px;'>
                                             <div class="hover">
                                                 <a href="#" class="addtocart">Add To Cart</a>
                                             </div>
                                         </div>
                                         <div class="content">
                                             <span class="category"><?php echo $show_products['description'];?></span>
                                             <a href="#"><h4 class="title"><?php echo $show_products['sellar']?></h4></a>
                                             <div class="price"><span class="sprice"><?php echo $show_products['price']?></span> <del class="dprice">$95.00</del></div>
                                         </div>
                    ...
                    <?php 
                         ...
                         require_once 'admin/functions/connect.php';
                         // $id = $_GET['id'];
                         $select_products = "SELECT * FROM products WHERE produc_id = '$id'";
                         $result_products = $connect -> query($select_products);
                         foreach($result_products as $show_products){
