...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:45 GMT -->
<head>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-element margin-bottom-20">
                        <input type="text" id="first_name" class="input-field first_name" placeholder="Enter first name">
                    </div>
                    <div class="form-element margin-bottom-20">
                        <input type="text" id="last_name" class="input-field last_name" placeholder="Enter last name">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-element margin-bottom-20">
                        <input type="text" id="email" class="input-field email" placeholder="Enter email address">
                    </div>
                    <div class="form-element margin-bottom-20">
                        <input type="text" id="subject" class="input-field subject" placeholder="Enter subject">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-element textarea margin-bottom-20">
                        <textarea  id="message" cols="30" rows="10" placeholder="Enter message" class="input-field textarea  message"></textarea>
                    </div>
                </div>
            </div>
            <div class="btn-wrapper">
...
<footer class="footer-arae-one">
    ...
    $('.myForm').submit(function(){
      ...
      if(f_name && l_name && _email && _subject && _message){
        
        $.post('admin/functions/add_message.php',{
...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:46 GMT -->
</html>