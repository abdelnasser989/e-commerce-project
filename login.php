...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:40:03 GMT -->
<head>
                        ...
                        <ul>
                            <li>
                                <div class="support-search-area">
                                    <form action="http://idealbrothers.thesoftking.com/html/bigenza/bigenja/index-3 class="search-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="right-contnet-area">
                                ...
                                <div class="bottom-content">
                                    <form  method="post"   action="admin/functions/check_cutomers.php" class="login-form">
                                        <div class="form-element">
                                            <input type="email" class="input-field" placeholder="Enter Username or Email" name="username">
                                        </div>
                                        <div class="form-element">
