...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:05 GMT -->
<head>
                        ...
                        <div class="col-lg-6">
                            <div class="right-contnet-area">
                                ...
                                <div class="bottom-content">
                                    <form method="post" action="admin/functions/add_customers.php" class="login-form">
                                        <div class="form-element">
                                            <input type="text" class="input-field" placeholder="Enter Username" name="first_name">
                                        </div>
                                        <div class="form-element">
                                            <input type="text" class="input-field" placeholder="Enter Your Last Name" name="last_name">
                                        </div>
                                        <div class="form-element">
                                            <input type="email" class="input-field" placeholder="Enter Your Email" name="email">
                                        </div>
                                        <div class="form-element">
                                            <input type="password" class="input-field" placeholder="Enter Your Password" name="password">
                                        </div>
                                        <div class="form-element">
                                            <input type="number" class="input-field" placeholder="Phone Number"  name="phone">
                                        </div> <div class="form-element">
                                            <input type="text" class="input-field" placeholder="Enter Your Address" name="address">
                                        </div>
                                        ...
                                        <div class="btn-wrapper">
                                            <button type="submit" class="submit-btn" name='submit'>signup</button>
